    ...
    <li id="post" class="tab-content min-h-screen p-12 closed hive">
        <header class="flex w-full mb-24">
            ...
            <div class="flex items-center">
                <a class="btn btn-one btn-icon" href="/panel/blog/create">
                    <i class="fas fa-pen"></i>
                </a>
                <a class="btn btn-one btn-icon ml-4" href="/panel/blog/create">
                    <i class="fas fa-trash"></i>
                </a>
                <a class="btn btn-white btn-icon" href="/panel/blog/create">
                    <i class="fas fa-check"></i>
                </a>
                <a class="btn btn-three btn-icon ml-4" href="/panel/blog/create">
