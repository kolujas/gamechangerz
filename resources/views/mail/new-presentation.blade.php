            ...
            <tr>
                <td style="background-color: #281B2D;">
                    <div style="color: #34495e; margin: 4% 10% 2%; text-align: justify;font-family: sans-serif">
                        <h2 style="text-align: center; color: #ED6744;margin: 20px 0;">Tu coach te envió una respuesta!</h2>
                        <p style="margin: 2px;padding-top: 2rem;text-align: center;font-family: sans-serif;font-size: 17px;min-height: 70px;background-color: #f8f8f8;padding: 1rem 1rem;margin-bottom: 2.5rem;">Ahora es momento de poner en práctica sus consejos. Tomate tu tiempo, entrená, y si aún te quedan assignments pendientes, mostrale tu progreso con una demo o video así podes seguir profundizando el trabajo.</p>
