<form id="signin" action="/login" method="post" class="grid pr-6 hidden">
    ...
    <main class="signin pl-12 pb-12 pr-6">
        ...
        <label class="input-group grid mb-6">
            <input class="signin form-input px-5 py-4 overpass" type="text" tabindex="2" name="signin_discord" id="signin_discord" placeholder="Username#0000" value={{ old("signin_discord", "") }}>
            @if ($errors->has("signin_discord"))
                <span class="error support mt-2 signin support-box hidden support-signin_discord overpass">{{ $errors->first("signin_discord") }}</span>
            @else
                <span class="error support mt-2 signin support-box hidden support-signin_discord overpass"></span>
            @endif
        </label>
        <label class="input-group grid mb-6">
