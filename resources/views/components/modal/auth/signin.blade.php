<form id="signin" action="/login" method="post" class="grid pr-6 hidden">
    ...
    <main class="signin pl-12 pb-12 pr-6">
        ...
        <label class="input-group grid mb-6">
            <input class="signin form-input px-5 py-4 overpass" type="text" tabindex="2" name="signin_email" id="signin_email" placeholder="Email" value={{ old('signin_email', '') }}>
        ...
        <label class="input-group grid mb-6">
            <div class="flex justify-between">
                <input class="signin form-input px-5 py-4 overpass" type="password" tabindex="3" name="signin_password" id="signin_password" placeholder="Contraseña">
        ...
        <label class="input-group grid mb-6">
            <div class="flex justify-between">
                <input class="signin form-input px-5 py-4 overpass" type="password" tabindex="4" name="signin_password_confirmation" id="signin_password_confirmation" placeholder="Confirmar contraseña">
        ...
        <div class="grid grid-cols-2 gap-6 mb-8">
            <div class="input-group">
                <label class="datepicker grid">
                    ...
                    <input type="date" placeholder="Fecha de nacimiento" tabindex="5" name="signin_date" id="signin_date" class="signin form-input px-5 py-4 overpass">
                </label>
            ...
            <div class="input-group">
                <select tabindex="6" name="signin_language" id="signin_language" class="signin form-input px-5 py-4 overpass">
        ...
        <div class="submit-group">
            <div class="input-group mb-6">
                <label class="text-white input-option flex mb-1">
                    <input id="signin_accept" type="checkbox" class="signin form-input" tabindex="7" name="signin_accept">
