        ...
        <form class="pr-6" id="assigment-form" action="#" method="post" class="grid">
            ...
            <main class="pl-12 py-12 pr-6">
                <div class="input-group grid">
                    ...
                    <input class="assigment-form form-input px-5 py-4 mb-4 overpass" type="text" name="title" placeholder="Titulo" value="">
                    @if ($errors->has('title'))
                        <span class="color-white error support assigment-form support-box overpass mb-4 support-title">{{ $errors->first('title') }}</span>
                    @else
                        <span class="color-white error support assigment-form support-box overpass mb-4 support-title"></span>
                    @endif
                </div>
                ...
                <div class="games-list my-8">
                    <div class="grid">
                        ...
                        <select class="px-5 py-4 assigment-form form-input mb-4" name="id_game">
                            <option class="overpass" selected disabled>Elegi un juego</option>
                        </select>
                        @if ($errors->has('id_game'))
                            <span class="color-white error support assigment-form support-box overpass mb-4 support-id_game">{{ $errors->first('id_game') }}</span>
                        @else
                            <span class="color-white error support assigment-form support-box overpass mb-4 support-id_game"></span>
                        @endif
                    </div>
                </div>
