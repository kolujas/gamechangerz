        ...
        <form class="pr-6" id="assigment-form" action="#" method="post" class="grid">
            ...
            <main class="pl-12 py-12 pr-6">
                <div class="input-group grid">
                    ...
                    @if ($errors->has('title'))
                        <span class="color-white error support support-box overpass mb-4 support-title">{{ $errors->first('title') }}</span>
                    @else
                        <span class="color-white error support support-box overpass mb-4 support-title"></span>
                    @endif
                </div>
                <div class="input-group grid my-2">
                    ...
                    @if ($errors->has('description'))
                        <span class="color-white error support support-box overpass mb-4 support-description">{{ $errors->first('description') }}</span>
                    @else
                        <span class="color-white error support support-box overpass mb-4 support-description"></span>
                    @endif
                </div>
                <div class="input-group grid my-2">
                    <h3 class="mb-4">
                    ...
                    <div id="myVideo"></div>
                    @if ($errors->has('url'))
                        <span class="color-white error support support-box overpass mb-4 support-url">{{ $errors->first('url') }}</span>
                    @else
                        <span class="color-white error support support-box overpass mb-4 support-url"></span>
                    @endif
                </div>
                ...
                <div class="games-list my-8">
                    <div class="grid">
                        ...
                        @if ($errors->has('id_game'))
                            <span class="color-white error support support-box overpass mb-4 support-id_game">{{ $errors->first('id_game') }}</span>
                        @else
                            <span class="color-white error support support-box overpass mb-4 support-id_game"></span>
                        @endif
                    </div>
                </div>
                ...
                <div class="abilities">
                    ...
                    @if ($errors->has('abilities'))
                        <span class="color-white error support support-box overpass support-abilities mb-4">{{ $errors->first('abilities') }}</span>
                    @else
                        <span class="color-white error support support-box overpass support-abilities mb-4"></span>
                    @endif
