<div class="p-8">
    <header class="tag flex items-center">
        ...
        <div class="username">
            <h3 class="color-white mb-2 overpass"><input class="update-input form-input russo" placeholder="Nombre de usuario" type="text" name="username" value="{{ old('username', $user->username) }}" disabled title="{{ $user->username }}"></h3>
