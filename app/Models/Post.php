<?php
    ...
    class Post extends Model {
        ...
        static public function allFromUser (int $id_user) {
            return Post::where("id_user", "=", $id_user)->get();
        }
        ...
        static public function fromAdmin () {
            return Post::join("users", "posts.id_user", "=", "users.id_user")->where("id_role", "=", 2)->select("posts.title", "posts.description", "posts.image", "posts.slug", "posts.id_user", "posts.updated_at")->orderBy("posts.updated_at", "desc")->limit(10)->get();
        }
